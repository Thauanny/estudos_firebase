...
class CustomRemoteConfig {
  ...
  CustomRemoteConfig._singleton();

  static final CustomRemoteConfig _instance = CustomRemoteConfig._singleton();

  static CustomRemoteConfig get instance => _instance;
  ...
  getValueOrDefault({
    ...
    switch (defaultValue.runtimeType) {
      ...
      default:
        Exception("Implementation not foud");
    }
  }
}
